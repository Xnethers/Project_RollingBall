...

{
    ...
    {
        testDataSerializedProperty = serializedObject.FindProperty("soundData");
    ...
    private void DrawElement(Rect rect, int index, bool isActive, bool isFocused)
    {
        ...
        arect.width = elementRect.width / 4;
        EditorGUI.PropertyField(arect, serElem.FindPropertyRelative("name"), GUIContent.none);
        arect.x += arect.width;
        arect.width = elementRect.width * 3 / 4; ;
        EditorGUI.PropertyField(arect, serElem.FindPropertyRelative("audioClip"), GUIContent.none);
    }
    ...
    private void DrawHeader(Rect rect)
    {
        ...
        arect.height = EditorGUIUtility.singleLineHeight;
        arect.x += 13;
        arect.width = headerRect.width / 4;
        EditorGUI.LabelField(arect, "Name");
        arect.x += arect.width;
        arect.width = headerRect.width * 3 / 4; ;
        EditorGUI.LabelField(arect, "Audio Clip");
    }
